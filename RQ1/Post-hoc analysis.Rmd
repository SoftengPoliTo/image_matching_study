...
visual_data = read.csv("visual_csv_results2.csv",header=TRUE,sep=";",stringsAsFactors = TRUE);
...
names(visual_data)[names(visual_data) == "percentage_tests"] <- "Percentage of passing tests"
